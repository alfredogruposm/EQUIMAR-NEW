    ...
    public partial class FacturasCtrl : Form
    {
        ...
        public decimal calculaimporte()
        {
            ...
            //{
                ...
                decimal DCB5 = decimal.Parse(CB5.Text);
                ...
                if (checkBox2.Checked == true)
                {
                    ...
                    {
                        cuotabasica = (ServicioContinuoR1 + ServicioContinuoR2 + ServicioContinuoR3) * Convert.ToDecimal(1.35);
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (checkBox2.Checked == true)
                    {
                        if (checkBox12.Checked == true)
                        {
                            cuotabasica = Convert.ToDecimal(DCB1 * Convert.ToDecimal(1.35));
                    ...
                    if (checkBox2.Checked == true)
                    {
                        if (checkBox12.Checked == true)
                        {
                            cuotabasica = cuotabasica * Convert.ToDecimal(1.35);
                        }
                        else
                        {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    facturasdao.formaDePago = "Parcialidades";
                }
                else
                {
        ...
        {
            if ((comboBox1.SelectedIndex == 1) | (comboBox1.SelectedIndex == 2) | (comboBox1.SelectedIndex == 3) | (comboBox1.SelectedIndex == 4) | (comboBox1.SelectedIndex == 5) | (comboBox1.SelectedIndex == 7) | (comboBox1.SelectedIndex == 8) | (comboBox1.SelectedIndex == 9))
            {
