...
namespace EquimarFac.GUI.CatalogosForms
{
    public partial class Tarifas : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if ((textBox1.Text != "") && (textBox12.Text != "") && (textBox2.Text != "") && (textBox3.Text != "") && (textBox4.Text != "") && (textBox5.Text != "") && (textBox6.Text != "") && (textBox7.Text != "") && (textBox8.Text != "") && (textBox9.Text != "") && (textBox10.Text != "") && (textBox11.Text != ""))
                {
                    DAO.CatalogosDAO catalogosdao = new EquimarFac.DAO.CatalogosDAO();
                    ...
                    catalogosdao.CuotaBasica5 = decimal.Parse(textBox12.Text);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                textBox12.Text = Convert.ToString(dataGridView1.CurrentRow.Cells[12].Value);
