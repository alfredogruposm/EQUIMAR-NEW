...
namespace EquimarFac.DAO
{
    class CatalogosDAO
    {
        ...
        public decimal CuotaBasica5 { get; set; }
        ...
        public string insertatarifas()
        {
            ...
            {
                BO.DS_CatalogosTableAdapters.TarifasTableAdapter tarifas = new EquimarFac.BO.DS_CatalogosTableAdapters.TarifasTableAdapter();
                tarifas.Insert(this.nombre, this.Cuota_Basica1, this.Cuotabasica2, this.CuotaBasica3, this.CuotaBasica4, this.RemolcadorExtraP, this.RemolcadorExtraM, this.RemolcadorExtraG, this.ServicioContinuoA, this.ServicioContinuoB, this.ServicioContinuoC, this.CuotaBasica5);
                return "Correcto";
            }
            catch
            {
        ...
        public string modifica_tarifas()
        {
            try
            {
                ...
                queries.modificatarifa(this.IDTarifas, this.nombre, this.Cuota_Basica1, this.Cuotabasica2, this.CuotaBasica3, this.CuotaBasica4, this.RemolcadorExtraP, this.RemolcadorExtraM, this.RemolcadorExtraG, this.ServicioContinuoA, this.ServicioContinuoB, this.ServicioContinuoC, this.CuotaBasica5);
                return "Correcto";
            }
            catch
            {
